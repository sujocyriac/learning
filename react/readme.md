...
You control *when* it runs — `useCallback` only helps with *reference stability*.
...
`React.memo`:
- ✅ Does shallow comparison on *its own props*
...
| Does it shallowly compare *its own* props?       | ✅ Yes         |
